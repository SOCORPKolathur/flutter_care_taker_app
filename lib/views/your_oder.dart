...
class YourOders extends StatefulWidget {
  const YourOders({super.key});

  @override
  State<YourOders> createState() => _YourOdersState();
}

class _YourOdersState extends State<YourOders> {
  String UID = "";
  @override
  void initState() {
  ...
  Future<void> _deleteItem(String docId) async {
    try {
      await FirebaseFirestore.instance
          ...
          .collection("MyOders") // Replace with your sub-collection name
          .doc(docId)
          .delete();
    } catch (e) {
